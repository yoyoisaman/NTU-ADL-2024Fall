...
def main():
    ...
    model, tokenizer = initialize_model(bnb_config, "yentinglin/Llama-3-Taiwan-8B-Instruct", "yentinglin/Llama-3-Taiwan-8B-Instruct")
    ...
    def train(epoch):
        ...
        for step, input_datas in enumerate(train_pbar):
            ...
            if global_step > 0 and global_step % 625 == 0:
